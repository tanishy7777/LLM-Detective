#!/bin/bash
#
#SBATCH --job-name=mistral_humanized    # A descriptive name for your job
#SBATCH --output=mistral_humanized_%j.log # Combined output and error log file (%j is the job ID)
