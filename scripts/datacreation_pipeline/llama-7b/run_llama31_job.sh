#!/bin/bash
#
#SBATCH --job-name=llama2_humanized    # A descriptive name for your job
#SBATCH --output=llama2_humanize_%j.log # Combined output and error log file (%j is the job ID)
